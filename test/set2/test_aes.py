...
class TestExpandKey(unittest.TestCase):
    def test_expand_128_bit_key(self):
        ...
        expanded = [
            chr(0x2b), chr(0x7e), chr(0x15), chr(0x16), chr(0x28), chr(0xae), chr(0xd2), chr(0xa6),
            chr(0xab), chr(0xf7), chr(0x15), chr(0x88), chr(0x09), chr(0xcf), chr(0x4f), chr(0x3c),
            chr(0xa0), chr(0xfa), chr(0xfe), chr(0x17), chr(0x88), chr(0x54), chr(0x2c), chr(0xb1),
            chr(0x23), chr(0xa3), chr(0x39), chr(0x39), chr(0x2a), chr(0x6c), chr(0x76), chr(0x05),
            chr(0xf2), chr(0xc2), chr(0x95), chr(0xf2), chr(0x7a), chr(0x96), chr(0xb9), chr(0x43),
            chr(0x59), chr(0x35), chr(0x80), chr(0x7a), chr(0x73), chr(0x59), chr(0xf6), chr(0x7f),
            chr(0x3d), chr(0x80), chr(0x47), chr(0x7d), chr(0x47), chr(0x16), chr(0xfe), chr(0x3e),
            chr(0x1e), chr(0x23), chr(0x7e), chr(0x44), chr(0x6d), chr(0x7a), chr(0x88), chr(0x3b),
            chr(0xef), chr(0x44), chr(0xa5), chr(0x41), chr(0xa8), chr(0x52), chr(0x5b), chr(0x7f),
            chr(0xb6), chr(0x71), chr(0x25), chr(0x3b), chr(0xdb), chr(0x0b), chr(0xad), chr(0x00),
            chr(0xd4), chr(0xd1), chr(0xc6), chr(0xf8), chr(0x7c), chr(0x83), chr(0x9d), chr(0x87),
            chr(0xca), chr(0xf2), chr(0xb8), chr(0xbc), chr(0x11), chr(0xf9), chr(0x15), chr(0xbc),
            chr(0x6d), chr(0x88), chr(0xa3), chr(0x7a), chr(0x11), chr(0x0b), chr(0x3e), chr(0xfd),
            chr(0xdb), chr(0xf9), chr(0x86), chr(0x41), chr(0xca), chr(0x00), chr(0x93), chr(0xfd),
            chr(0x4e), chr(0x54), chr(0xf7), chr(0x0e), chr(0x5f), chr(0x5f), chr(0xc9), chr(0xf3),
            chr(0x84), chr(0xa6), chr(0x4f), chr(0xb2), chr(0x4e), chr(0xa6), chr(0xdc), chr(0x4f),
            chr(0xea), chr(0xd2), chr(0x73), chr(0x21), chr(0xb5), chr(0x8d), chr(0xba), chr(0xd2),
            chr(0x31), chr(0x2b), chr(0xf5), chr(0x60), chr(0x7f), chr(0x8d), chr(0x29), chr(0x2f),
            chr(0xac), chr(0x77), chr(0x66), chr(0xf3), chr(0x19), chr(0xfa), chr(0xdc), chr(0x21),
            chr(0x28), chr(0xd1), chr(0x29), chr(0x41), chr(0x57), chr(0x5c), chr(0x00), chr(0x6e),
            chr(0xd0), chr(0x14), chr(0xf9), chr(0xa8), chr(0xc9), chr(0xee), chr(0x25), chr(0x89),
            chr(0xe1), chr(0x3f), chr(0x0c), chr(0xc8), chr(0xb6), chr(0x63), chr(0x0c), chr(0xa6),
        ]

        self.assertEqual(aes.expand_key(key, 10), expanded)
